      ...
      <section className="w-full h-[70vh] md:h-185 relative">
        ...
        <div className="absolute inset-0 z-20 flex items-start py-20 justify-center">
          <div className="text-center text-white">
            ...
            <img
              className="w-6/8 max-w-150 sm:w-3/8 md:4/8 lg:3/8 md:max-w-270 h-auto mx-auto "
              src={baybayonLogo}
            />
            <button className="mt-0 sm:mt-[-10px] bg-secondary text-primary uppercase px-6 py-2 rounded-full text-md sm:text-lg font-semibold hover:bg-secondary/90 transition-colors">
              Shop Now
            </button>
          </div>
        </div>
