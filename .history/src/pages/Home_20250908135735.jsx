...
const Home = () => {
  return (
    <main className="relative overflow-x-hidden">
      ...
      <section className=" relative overflow-hidden w-[140vw] flex items-center justify-center gap-4 sm:gap-6 mb-25   z-30 -mt-51 md:-mt-60 lg:-mt-70 left-1/2 -translate-x-1/2">
        <img
          src={fish1}
          alt="Fish 1"
