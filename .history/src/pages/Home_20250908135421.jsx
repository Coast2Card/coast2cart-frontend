        ...
        <div className="absolute inset-0 z-20 flex items-start py-20 justify-center">
          <div className="text-center text-white">
            ...
            <img
              ...
              src={baybayonLogo}
            />
            <button className="mt-0 sm:mt-[-10px] sm:mb-20 bg-secondary text-primary uppercase px-6 py-2 rounded-full text-md sm:text-lg font-semibold hover:bg-secondary/90 transition-colors">
              Shop Now
            </button>
          </div>
        </div>
