...
const Home = () => {
  return (
    <main className="relative overflow-x-hidden">
      ...
      <section className=" relative overflow-hidden w-[140vw] flex items-center justify-center gap-4 sm:gap-6 mb-25   z-30 -mt-45 md:-mt-75 lg:-mt-75 left-1/2 -translate-x-1/2">
        <img
          src={fish1}
          alt="Fish 1"
