      ...
      <section className="flex flex-col gap-4 mx-4">
        ...
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-35 gap-4 h-100">
            <div className="col-span-11 bg-red-100 rounded-md h-[100%]"></div>
            <div className="col-span-8 bg-red-100 rounded-md h-[55%]"></div>
            <div className="col-span-8 bg-red-100 rounded-md h-[55%]"></div>
            <div className="col-span-8 bg-red-100 rounded-md h-[55%]"></div>
          </div>
          <div className="bg-amber-300 mx-auto w-[70%] h-80 mt-[-20%]"></div>
        </div>
      </section>
    </main>
  );
