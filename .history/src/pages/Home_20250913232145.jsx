...
const Home = () => {
  return (
    <main className="relative overflow-x-hidden bg-base-300">
      ...
      <section className="flex flex-col gap-4 mx-4 mb-20">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative flex-flex-col gap-2 bg-[#FFCD0F] p-6 px-8 rounded-md text-[#012466] mx-auto w-[55%]  mt-[-19%]">
