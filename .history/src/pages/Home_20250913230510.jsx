    ...
    <main className="relative overflow-x-hidden">
      ...
      <section className="flex flex-col gap-4 mx-4">
        ...
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-30 gap-4 h-100">
            <div className="col-span-9 bg-red-100 h-[100%]"></div>
            <div className="col-span-7 bg-red-100 h-[55%]"></div>
            <div className="col-span-7 bg-red-100 h-[55%]"></div>
            <div className="col-span-7 bg-red-100 h-[55%]"></div>
          </div>
          <div className="bg-amber-300 translate-x-1/2 w-[50%] h-100 mt-[-20%]"></div>
        </div>
      </section>
    </main>
  );
