    ...
    <main className="relative overflow-x-hidden bg-base-300">
      ...
      <section className="flex flex-col gap-4 mb-60">
        ...
        <div className="relative flex flex-col gap-3 mx-3 ml-18">
          ...
          <div className="absolute relative top-[100%] -translate-y-3/5  left-1/2 -translate-x-1/2 flex-flex-col gap-2 bg-[#FFCD0F] p-6 px-8 rounded-md text-[#012466] w-[50%] ">
            ...
            <div className="z-[10] right-[-50px] top-0 flex gap-2 bg-base-100 w-100">
