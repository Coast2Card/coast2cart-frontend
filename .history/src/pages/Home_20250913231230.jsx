    ...
    <main className="relative overflow-x-hidden">
      ...
      <section className="flex flex-col gap-4 mx-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex-flex-col gap-2 bg-[#FFCD0F] p-6 rounded-md text-[#012466] mx-auto w-[60%]  mt-[-19%]">
            <h2 className="font-bold text-xl mb-1">John Ortazo</h2>
            <p className="font-semibold mb-4">Barangay Chairman</p>
            <p className="">
