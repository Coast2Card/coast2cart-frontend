...
const Home = () => {
  return (
    <main className="relative overflow-x-hidden bg-base-300 mx-4">
      {/* Home Banner */}
      ...
      <section className="flex flex-col gap-4 mb-60">
        ...
        <div className="relative flex flex-col gap-3 mx-3 ">
          ...
          <div className="absolute z-[10] right-1/12 bottom-0 flex gap-2 ">
            <button className="bg-base-200 w-10 h-10 p-2  rounded-full">
