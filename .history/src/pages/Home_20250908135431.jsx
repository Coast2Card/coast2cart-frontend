      ...
      <section className="w-full h-[70vh] md:h-185 relative">
        ...
        <div className="absolute inset-0 z-20 flex items-start py-20 justify-center">
          <div className="text-center text-white">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-extrabold font-display mb-[-15px] sm:mb-[-30px] md:mb-[-35px] lg:mb-[-47px]">
              Sea the best of Baybayon, from
            </h1>
            <img
              className="w-6/8 max-w-120 sm:w-6/8 md:4/8 lg:3/8 md:max-w-270 h-auto mx-auto "
              src={baybayonLogo}
            />
            <button className="mt-0 sm:mt-[-10px] sm:mb-30 bg-secondary text-primary uppercase px-6 py-2 rounded-full text-md sm:text-lg font-semibold hover:bg-secondary/90 transition-colors">
              Shop Now
            </button>
          </div>
        </div>
      </section>
      <section className=" relative overflow-hidden w-[140vw] flex items-center justify-center gap-4 sm:gap-6 mb-25   z-30 -mt-51 sm:-mt-60 left-1/2 -translate-x-1/2">
        <img
          src={fish1}
          alt="Fish 1"
          className="min-w-20 h-40 md:w-65 md:h-90  object-cover rounded-2xl"
        />
        <img
          src={fish2}
          alt="Fish 2"
          className="min-w-35 h-55  md:w-80 md:h-110 object-cover rounded-2xl"
        />
        <img
          src={fish3}
          alt="Fish 3"
          className="min-w-46 h-70 md:w-95 md:h-125 object-cover rounded-2xl"
        />
        <img
          src={fish4}
          alt="Fish 4"
