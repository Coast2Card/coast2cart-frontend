...
const Home = () => {
  return (
    <main className="relative overflow-x-hidden bg-base-300">
      ...
      <section className="flex flex-col gap-4 mx-4 mb-60">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="absolute bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 flex-flex-col gap-2 bg-[#FFCD0F] p-6 px-8 rounded-md text-[#012466] w-[55%] ">
