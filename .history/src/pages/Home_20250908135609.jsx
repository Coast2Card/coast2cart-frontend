...
const Home = () => {
  return (
    <main className="relative overflow-x-hidden">
      ...
      <section className="w-full h-[70vh] md:h-185 relative">
        ...
        <div className="absolute inset-0 z-20 flex items-start py-20 justify-center">
          <div className="text-center text-white">
            ...
            <img
              className="w-6/8 max-w-120 sm:w-6/8 md:4/8 lg:3/8 md:max-w-180 h-auto mx-auto "
              src={baybayonLogo}
            />
      ...
      <section className=" relative overflow-hidden w-[140vw] flex items-center justify-center gap-4 sm:gap-6 mb-25   z-30 -mt-51 md:-mt-60 left-1/2 -translate-x-1/2">
        <img
          src={fish1}
          alt="Fish 1"
