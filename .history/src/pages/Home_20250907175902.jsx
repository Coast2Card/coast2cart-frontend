    ...
    <main className="relative overflow-x-hidden">
      ...
      <section className="w-full h-[70vh] md:h-185 relative">
        ...
        <div className="absolute inset-0 z-20 flex items-start py-20 justify-center">
          <div className="text-center text-white">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-extrabold font-display mb-[-20px] sm:mb-[-30px] md:mb-[-35px] lg:mb-[-47px]">
      ...
      <section className=" relative overflow-hidden w-[140vw] flex items-center justify-center gap-4 sm:gap-6 mb-25   z-30 -mt-61 sm:-mt-60 left-1/2 -translate-x-1/2">
        ...
        <img
          src={fish2}
          alt="Fish 2"
          className="min-w-35 h-55  sm:w-80 sm:h-110 object-cover rounded-2xl"
        />
        <img
          src={fish3}
          alt="Fish 3"
          className="min-w-46 h-70 sm:w-95 sm:h-125 object-cover rounded-2xl"
        />
        <img
          src={fish4}
          alt="Fish 4"
