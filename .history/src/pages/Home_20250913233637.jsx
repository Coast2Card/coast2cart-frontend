  ...
  return (
    <main className="relative overflow-x-hidden bg-base-300">
      ...
      <section className="flex flex-col gap-4 mb-60">
        ...
        <div className="relative flex flex-col gap-3 mx-3 ml-18">
          ...
          <div className="absolute top-[100%] -translate-y-3/5  left-1/2 -translate-x-1/2 flex-flex-col gap-2 bg-[#FFCD0F] p-6 px-8 rounded-md text-[#012466] w-[50%] ">
          ...
          <div className="absolute z-[10] right-0 bottom-0 flex gap-2 ">
            <button className="bg-base-200 w-10 h-10 p-2 fton- rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                <rect width="256" height="256" fill="bold" />
                <line
                  x1="216"
                  y1="128"
                  x2="40"
