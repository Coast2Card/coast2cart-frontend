    ...
    <main className="relative overflow-x-hidden">
      ...
      <section className=" relative overflow-hidden w-[140vw] flex items-center justify-center gap-6 mb-25   z-30 -mt-61 sm:-mt-60 left-1/2 -translate-x-1/2">
        ...
        <img
          src={fish3}
          alt="Fish 3"
          className="min-w-75 h-115 sm:w-95 sm:h-125 object-cover rounded-2xl"
        />
        <img
          src={fish4}
          alt="Fish 4"
          className="min-w-65 h-90 sm:w-80 sm:h-110 object-cover rounded-2xl"
        />
        <img
          src={fish5}
          alt="Fish 5"
      ...
      <section className="max-w-8xl mx-auto flex flex-col">
