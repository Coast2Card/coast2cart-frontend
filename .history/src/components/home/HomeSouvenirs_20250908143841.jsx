      ...
      <div className="relative flex items-end justify-end h-150 w-full min-w-100 max-w-70">
        ...
        <div className="absolute flex items-end justify-end p-6 px-8 inset-0 ">
          <div className="flex flex-col">
            ...
            <button className=" bg-secondary text-primary uppercase px-6 py-2 rounded-full text-md  font-semibold hover:bg-secondary/90 transition-colors cursor-pointer"></button>
          </div>
        </div>
        <img
