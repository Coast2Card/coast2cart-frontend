...
const HomeGallery = () => {
  return (
    <div className="w-full flex gap-4 mb-20 items-center justify-center mx-auto max-w-7xl bg-red-100  ">
      <div className="flex flex-1 min-w-75  w-full h-150 bg-blue-100 ">
        <img src={homeGallery1} className="w-full h-full object-cover  " />
      </div>
      <div className=" flex flex-col min-w-20 max-w-200 p-4 gap-4 justify-center">
