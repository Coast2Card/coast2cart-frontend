...
const HomeGallery = () => {
  return (
    <div className="w-full flex gap-4 mb-20 bg-red-100 ">
      <div className="flex-1 min-w-80 w-full h-full ">
        <img src={homeGallery1} className="w-full h-full  " />
      </div>
      <div className=" flex flex-col min-w-20  p-4 gap-4 justify-center">
        ...
        <div className="flex items-start gap-4 text-primary">
          ...
          <div className="flex flex-col">
            <h3 className="font-bold text-xl">Sustainably Caught</h3>
