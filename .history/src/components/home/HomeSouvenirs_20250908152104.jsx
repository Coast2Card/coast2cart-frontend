...
const HomeSouvenirs = () => {
  return (
    <>
      <div className="relative flex items-end justify-end h-90 lg:h-150 w-full min-w-100 lg:max-w-70">
      ...
      <article className="flex-1 flex flex-col justify-center p-4 py-8 lg:p-6 text-white text-md gap-2">
        <p className="mb-4">
