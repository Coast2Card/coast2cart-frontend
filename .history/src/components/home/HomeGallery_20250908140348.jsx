...
const HomeGallery = () => {
  return (
    <div className="w-full flex flex-col sm:flex-row gap-9 lg:gap-12 p-1 mb-20 items-center justify-center mx-auto max-w-7xl  ">
      ...
      <div className=" flex flex-col min-w-20 max-w-200  gap-4 justify-center">
        ...
        <div className="flex items-start gap-4 text-primary mb-4">
          <div className="max-h-22 min-w-11 font-bold pt-0.5">
            <FishIcon />
          </div>
        ...
        <div className="flex items-start gap-4 text-primary">
          ...
          <div className="flex flex-col">
            <h3 className="font-bold text-xl mb-2">Guaranteed Freshness</h3>
            <p className="text-black">
              From the moment it is caught to the time it reaches you, every
              fish is handled with care to preserve its natural taste and
              nutrients.
            </p>
          </div>
        </div>
