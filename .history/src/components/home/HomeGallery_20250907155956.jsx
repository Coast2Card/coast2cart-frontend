...
const HomeGallery = () => {
  return (
    <div className="w-full flex flex-col sm:flex-row gap-5 lg:gap-8 mb-20 items-center justify-center mx-auto max-w-7xl  ">
      <div className="flex flex-1 min-w-75 md:min-w-85  w-full h-150 bg-blue-100 ">
