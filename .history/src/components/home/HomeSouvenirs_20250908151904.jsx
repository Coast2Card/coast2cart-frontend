...
const HomeSouvenirs = () => {
  return (
    <>
      <div className="relative flex items-end justify-end h-90 lg:h-155 w-full min-w-100 lg:max-w-70">
        <div className="absolute flex items-end justify-end p-6 px-8 inset-0  bg-black opacity-40"></div>
        <div className="absolute flex items-end justify-start lg:justify-end p-6 py-10 lg:py-6 px-8 inset-0 ">
