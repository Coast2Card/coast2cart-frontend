...
const HomeGallery = () => {
  return (
    <div className="w-full flex flex-col md:flex-row gap-9 lg:gap-12 p-4 mb-20 items-center justify-center mx-auto max-w-7xl  ">
      <div className="flex flex-1 md:min-w-75 max-w- md:min-w-95  w-full md:h-150 bg-blue-100 ">
