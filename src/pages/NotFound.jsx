      ...
      <div className="relative w-full max-w-4xl overflow-hidden rounded-2xl shadow-lg">
        ...
        <div className="relative z-10 bg-base-100/70 backdrop-blur-sm p-8 md:p-12">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/seafood" className="btn btn-secondary">
              Explore Seafood
            </Link>
            <Link to="/souvenirs" className="btn btn-accent">
              Browse Souvenirs
            </Link>
          </div>
        </div>
        ...
        <img
          src={fish1}
          alt="fish"
          className="hidden md:block absolute -left-8 bottom-6 h-20 opacity-80 animate-fade-scale-in"
          style={{ animationDelay: "80ms" }}
        />
        <img
          src={fish2}
          alt="fish"
          className="hidden md:block absolute right-4 -bottom-6 h-24 opacity-80 animate-fade-scale-in"
          style={{ animationDelay: "160ms" }}
        />
        <img
          src={fish3}
          alt="fish"
          className="hidden md:block absolute right-28 top-6 h-16 opacity-70 animate-fade-scale-in"
