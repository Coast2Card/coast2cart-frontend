  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24">
        <h2 className="text-10xl md:text-5xl font-bold text-[#012466] text-center mb-10">About Us</h2>
      ...
      <section className="py-8 sm:py-12 px-4 sm:px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-center gap-6 sm:gap-8">
        ...
        <div className="w-full md:w-1/2">
          <div className="flex items-center mb-6">
            <h2 className="text-5xl md:text-4xl font-bold text-orange-500 whitespace-nowrap">LIFE BY THE SEA</h2>
      ...
      <section className="py-8 sm:py-12 px-4 sm:px-6 md:px-12 lg:px-24 flex flex-col md:flex-row-reverse items-center gap-6 sm:gap-8">
        ...
        <div className="w-full md:w-3/5">
          <div className="flex items-center mb-6">
            <h2 className="text-2xl md:text-4xl font-bold text-orange-500 whitespace-nowrap">SOUVENIRS AND LOCAL CRAFT</h2>
            <div className="h-[1px] bg-gray-400 flex-grow ml-4"></div>
          </div>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="text-left">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#012466] mb-8">FRESH AND LOCAL</h2>
          ...
          <div className="text-right">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#012466] mb-8">SMALL-SCALE TOURISM</h2>
