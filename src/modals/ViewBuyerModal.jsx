...
const ViewBuyerModal = ({ open, onClose, buyer }) => {
  if (!open) return null;
  const sample = buyer || {
    id: "2022-123456",
    firstName: "Anna",
    ...
    lastName: "Anume",
    suffix: "Jr.",
    email: "nanaruze@gmail.com",
    contact: "N/A",
    address: "129384Gdadascascas",
    username: "ananagandabem",
    password: "...........",
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white w-[92vw] sm:w-[720px] rounded-[24px] border-4 border-warning shadow-2xl overflow-hidden">
        ...
        <div className="bg-accent text-accent-content py-5 px-6 text-center relative">
          ...
          <h2 className="text-3xl font-extrabold tracking-wide">BUYER ACCOUNT</h2>
        </div>
          ...
          <div className="max-w-[660px] mx-auto md:flex md:items-start md:gap-8">
            ...
            <div className="flex-1 space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-extrabold">BUYER ID: {sample.id}</div>
                  {!isEditing && (
                    <button
